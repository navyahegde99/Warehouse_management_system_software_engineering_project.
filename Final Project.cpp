...
int main()
{
	...
	{
		system("cls");
	disp();getch();goto suppliermenu;
	}
	else if(i==3)
	{
		refill();goto suppliermenu;
	}
	else if(i==4)
	{
		remove();getch();goto suppliermenu;
	}
	else 
	{
		system("cls");
	cout<<"\n\n\n\t\t\tDeveloped by NavyaNayanaShloka";
	getch();
	exit(0);
}
}
...

{
	...
	if(strcmp(pass2,"Pickeraccess")==0)
	{
	pickermenu:
	system("cls");
	cout<<"=================================================================";
	...
	{
		system("cls");
	disp();getch();goto pickermenu;
	}
	else if(i==2)
	{
		refill();goto pickermenu;
	}
	else 
	{
		system("cls");
